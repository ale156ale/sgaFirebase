...
document.addEventListener('DOMContentLoaded', () => {
  ...
  formNovoUsuario.addEventListener('submit', (event) => {
    ...
    const privilegio = document.getElementById('privilegioNovo').value;
    ...
    if (usuario === '') {
      ...
      novoUsuarioADM(usuario, email, senha, privilegio, cpf, turma, nota1, nota2, nota3, nota4, nascimento, sexoSelecionado);
    }
  });
});
