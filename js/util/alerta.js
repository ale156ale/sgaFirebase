...
function alerta(mensagem, tipo) {
  ...
  function alerta2(mensagem2, tipo2) {
    let mensagemAlerta2 = document.getElementById('mensagemAlerta2')
    let wrapper2 = document.createElement('div')
    wrapper2.innerHTML = '<div class="alert alert-' + tipo2 + ' alert-dismissible m-3" role="alert">' + mensagem2 + '<button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button></div>'
    mensagemAlerta2.append(wrapper2)
    //Auto Close após 3 segundos
    window.setTimeout(function () {
      wrapper2.innerHTML = ''
    }, 3000);
    //Iremos fazer o scroll até a div da mensagem
        mensagemAlerta2.scrollIntoView();
  }
